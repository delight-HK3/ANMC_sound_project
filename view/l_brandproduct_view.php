			...
			<div class="row" style="margin-left:55px">	
				...
				<div class="card" style="width: 30rem; margin:10px; height:355px; border:1px; border-color: lightgray; border-style: solid; border-width: 1px; ">
					<h4 class="card-header bg-primary" >
						<font style="color:white"><?php echo $row->name25?></font>
					</h4>
					<div class="card-body">
						<p style="text-align:left; margin-left:20px; font-size:20px;">
							<b>구분명 :</b> <?php echo $row->gubun_name25?>
						</p>
						<p style="text-align:left; margin-left:20px; font-size:20px;">
							<b>브랜드명 :</b> <?php echo $row->brand_name25?>
						</p>
						<p style="text-align:left; margin-left:20px; font-size:20px;">
							<b>가격 :</b> <?php echo number_format($row->price25)?>
						</p>
					</div>
