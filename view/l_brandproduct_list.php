<div style="background-color:#e6e6e6">
	...
	?>		
			<div style="background-color:white" class="container" ><br>
				<center><h4><b>"<?php echo $brandname->brand_name25;?>"</b> 브랜드는 <b><?php echo $total?></b> 개 제품이 존재합니다.</h4></center>
			...
			?>
					<div class="card text-center shadow bg-body rounded" style="width: 16rem; margin:10px;">
						...
						<h5 class="card-title"><a href="/l_brandproduct/view/no/<?php echo $row->no25?>/page/<?php echo $page?>"><?php echo $row->name25 ?></a></h5>
