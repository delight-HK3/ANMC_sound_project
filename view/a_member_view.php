		...
		<form name="form1" method="post" action="">
			<table class="table table-bordered table-sm mymargin5">
				...
				<tr>
					...
					<td width="80%" align="left"><?php echo $row->name25?></td>
				</tr>
				 <tr>
					<td width="20%" class="productcolor1" style="vertical-align:middle">아이디</td>
					<td width="80%" align="left"><?php echo $row->uid25?></td>
				</tr>
				<tr>
					<td width="20%" class="productcolor1" style="vertical-align:middle">암호</td>
					<td width="80%" align="left"><?php echo $row->pwd25?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="80%" align="left"><?php echo $rank?></td>
				</tr>
			</table>
			<div align="center">
				<a href="/a_member/edit<?php echo $tmp?>" class="btn btn-sm productcolor1">수정</a>
				<a href="/a_member/del<?php echo $tmp?>" class="btn btn-sm productcolor1" onClick="return confirm('삭제할까요 ?')">삭제</a>
