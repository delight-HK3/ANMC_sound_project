 	<div class="alert productcolor1 mymargin5" role="alert">브랜드선택</div>
		<script>
			function find_text()
			{
				if(!form1.text1.value){
					form1.action="/~sale25/a_brand/noajax_lists/page";
				}
				else{
					form1.action="/~sale25/a_brand/noajax_lists/text1/"+form1.text1.value+"/page";
				}
				form1.submit();
			}
		...
		<table class="table table-bordered table-sm mymargin5">
			...
			<tr>
				<td><?=$no; ?></td>
				<td><a href="javascript:SendBrand(<?=$row->no25?>,'<?=$row->name25?>');"><?=$row->name25?></a></td>
			</tr>
			<?
				}
			?>
