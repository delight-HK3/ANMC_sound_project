...
<html lang="kr">
	<head>
		...
		<link href="/my/css/fontawesome-all.css" rel="stylesheet">
		<link href="/my/css/ihover.css" rel="stylesheet">
		<link href="/my/css/ihover.min.css" rel="stylesheet">
	...
	<script>
		function find_text()
		{
			if(!form1.text1.value){
				...
				form1.action="/l_main/find/text1/"+form1.text1.value+"/page";
			}
			form1.submit();
		}
	</script>
	<body>
		<div>
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
				<a class="navbar-brand" href="/l_main">HOME</a>
				<form name="form1" method="post" action="">
					<div class="input-group input-group-sm">
						<div class="input-group-append">
							&nbsp&nbsp<input type="search" name="text1" value="<?php echo $text1?>" class="form-control" placeholder="검색" onkeydown="if (event.keyCode == 13) { find_text(); }" >
							<button type="submit" onclick="javascript:find_text();" class="btn btn-primary btn-default" >
			  	...
			  	<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
								<?php
									...
									{	
										$no=$row->no25;// 구분번호
								?>
										<a class='dropdown-item' href="/l_gubunproduct/lists/no/<?php echo $no?>"><?php echo $row->name25?></a>
								<?php
									}
								?>
							</div>
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
								<?php
									foreach($list2 as $row)
									{
										$no=$row->no25;// 구분번호
								?>
                                    						<a class='dropdown-item' href="/l_brandproduct/lists/no/<?php echo $no?>"><?php echo $row->name25?></a>
								<?php
									}
								?>
							</div>
                    				...
                    				<li class="nav-item"><a class="nav-link" href="/main">판매관리</a></li>
						<?php	
					...
					<?php		
						if(!$this->session->userdata("uid")){
							...
							echo("<a href='/l_login/logout' class='btn btn-sm btn-outline-success'>로그아웃</a>");
						}
					?>
				</div>
			</nav>	
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content" style="width:400px;">
						...
						<div style="width: 400px;" class="modal-body bg-light" style="text-align:Center">
							<center><br><br>
								<img style="width: 250px; height: 250px; border-radius: 70%;" src="/my/img/ANMC_logo.png">
							</center><br><br>
							<form name="form_login" method="post" action="/l_login/check">
				...
				<ol class="carousel-indicators">
			  	...
			  	<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="/my/img/main_1.PNG" class="d-block w-100" height="550" alt="First slide">
					</div>
					<div class="carousel-item">
						<img src="/my/img/main_2.PNG" class="d-block w-100" height="550" alt="Second slide">
					</div>
					<div class="carousel-item">
						<img src="/my/img/main_3.PNG" class="d-block w-100" height="550" alt="Third slide">
					</div>
					<div class="carousel-item">
						<img src="/my/img/main_4.PNG" class="d-block w-100" height="550" alt="Third slide">
					</div>
			  	</div><hr>
