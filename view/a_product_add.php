		...
		<form name="form1" method="post" action="" enctype="multipart/form-data">
			...
			<table class="table table-bordered table-sm mymargin5">
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline">
							<input  type="text" name="name" size="20" value="<?=set_value("name") ?>"  class="form-control form-control-sm">
						</div>
						<? 
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline">
							<input type="hidden" name="progubun_no" value="<?=set_value("gubun_no"); ?>">
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline">
							<input type="hidden" name="probrand_no" value="<?=set_value("brand_no"); ?>">
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="form-inline">
							<input  type="text" name="price" size="20" maxlength="20" value="<?=set_value("price") ?>"  class="form-control form-control-sm">
						</div>
						<? 
