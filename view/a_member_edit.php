	<div class="alert productcolor1 mymargin5" role="alert">사용자</div>
		<form name="form1" method="post" action="">
			...
			<tr>
				...
				<td width="80%" align="left">
					<div class="form-inline">
						<input  type="text" name="name" size="20" maxlength="20" value="<?=$row->name25 ?>"  class="form-control form-control-sm">
					</div>
					<? 
			...
			<tr>
				...
				<td width="80%" align="left">
					<div class="form-inline">
						<input  type="text" name="uid" size="20" maxlength="20" value="<?=$row->uid25 ?>" class="form-control form-control-sm">
					</div>
					<? 
			...
			<tr>
				...
				<td width="80%" align="left">
					<div class="form-inline">
						<input  type="password" name="pwd" size="20" maxlength="20" value="<?=$row->pwd25 ?>" class="form-control form-control-sm">
					</div>
					<? 
