		...
		<div style="background-color:white" class="container"><br>
			<div class="row" style="margin-left:55px">	
				<div class="card" style="width: 30rem; margin:10px; "><br>
					<center>
						<div style="height:555px; width:430px;">	
							<div class="viewbox">
								<img src="/product_img/<?php echo $row->changepic25?>">
								<img src="/product_img/<?php echo $row->pic25?>">
							</div>
							<br>
							<div class="miniimg" style="float:left" >
								<img src="/product_img/<?php echo $row->pic25?>">&nbsp&nbsp
								<img src="/product_img/<?php echo $row->changepic25?>">	
							</div>
						</div>
					</center>
				...
				<div class="card" style="width: 30rem; margin:10px; height:355px; border:1px; border-color: lightgray; border-style: solid; border-width: 1px; ">
					<h4 class="card-header bg-primary" ><font style="color:white"><?php echo $row->name25?></font></h4>
					<div class="card-body">
						<p style="text-align:left; margin-left:20px; font-size:20px;"><b>구분명 :</b> <?php echo $row->gubun_name25?></p>
						<p style="text-align:left; margin-left:20px; font-size:20px;"><b>브랜드명 :</b> <?php echo $row->brand_name25?></p>
						<p style="text-align:left; margin-left:20px; font-size:20px;"><b>가격 :</b> <?php echo number_format($row->price25)?></p>
					</div>
			...
			<center>
				...
				<img src="/product_img/<?php echo $row->detailpic25?>">
				<br><br><br><br><br>
			</center>
		</div>
	<hr style="border:solid 10px #e6e6e6;">
