...
?>	
		<div style="background-color:white;" class="container">
			...
			<center>
			<br><h3><b>"<?=$text1?>"</b>으로 검색한 상품이 없습니다.</h3><br>
			</center>
		</div>
<?
	}
...
?>		
		...
		<center><h4><b>"<?=$text1?>"</b>으로 검색한 결과 <b>"<?=$total?>"</b>개의 제품이 존재합니다.</h4></center>
...
?>
				<div class="card text-center shadow bg-body rounded" style="width: 16rem; margin:10px;">
				  <center><div class="box">
					...
					<h5 class="card-title"><a href="/~sale25/l_gubunproduct/view/no/<?=$row->no25?>/page/<?=$page?>"><?=$row->name25 ?></a></h5>
